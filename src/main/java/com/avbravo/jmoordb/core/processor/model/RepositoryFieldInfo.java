 ...
 */
public class RepositoryFieldInfo {

    private final LinkedHashMap<String, String> fields;
    private final List<String> mandatoryFields;

    public RepositoryFieldInfo(LinkedHashMap<String, String> fields, List<String> mandatoryFields) {
...
// </editor-fold>
    ...
    public static RepositoryFieldInfo get(Element element) {
        ...
        return new RepositoryFieldInfo(fields, mandatoryFields);
    }
// </editor-fold>
