 ...
 */
public class RepositoryBasicFieldInfo {

    private final LinkedHashMap<String, String> fields;
    private final List<String> mandatoryFields;

    public RepositoryBasicFieldInfo(LinkedHashMap<String, String> fields, List<String> mandatoryFields) {
...
// </editor-fold>
    ...
    public static RepositoryBasicFieldInfo get(Element element) {
        ...
        return new RepositoryBasicFieldInfo(fields, mandatoryFields);
    }
// </editor-fold>
